...
* Ability to analyse logs using fields, time ranges, and filters
* Experience with subsearches and advanced SPL pipelines
* Knowledge of lookup tables and data enrichment
* Creating reports, dashboards, and visualisations
...
* Cryptomator - secure storage of raw project artefacts and screenshots
...
### 1. Data Ingestion Using the Add Data Wizard
...
* Understood the differences between historical and real-time searches
...
### 7. Reports, Dashboards & Visualisations

* Saved SPL searches as reports
* Built dashboards with multiple panels
* Created visualisations (pie, column, line, sparkline)
...
* 🔐 All raw evidences are securely stored using encryption
